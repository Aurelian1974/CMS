...
public sealed class UpdateClinicLocationCommandValidator : AbstractValidator<UpdateClinicLocationCommand>
{
    public UpdateClinicLocationCommandValidator()
    {
        RuleFor(x => x.Id)
            .NotEmpty().WithMessage("Id-ul locației este obligatoriu.");
