...
public sealed class UpdateAnalysesResultCommandValidator : AbstractValidator<UpdateAnalysesResultCommand>
{
    public UpdateAnalysesResultCommandValidator()
    {
        RuleFor(x => x.Id)
            .NotEmpty().WithMessage("Id-ul buletinului este obligatoriu.");
